...
contract Wallet {
    ...
    function sendTrancsactionWithCommision(address dest, uint128 value) public pure checkOwnerAndAccept {
        dest.transfer(value, true, 1);
    }

    function sendAllTrancsactionAndDelete(address dest, uint128 value) public pure checkOwnerAndAccept {
        dest.transfer(value, true, 192);
    }
}